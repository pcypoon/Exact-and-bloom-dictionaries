...
allexact: spellexact spellexact_s testexact testexact_s spellexact_x
...
spellexact_x: Exact/exact.c spelling.c general.c
	$(CC) spelling.c Exact/exact.c general.c $(VALGRIND) -o spellexact_x -lm
...
clean: 
	rm -f spellapprox spellexact spellapprox_s spellexact_s spellexact_x testapprox testexact testapprox_s testexact_s
